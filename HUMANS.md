...
- **Remix text**: select any passage (even in core content) → ✨ in the popup (or right-click) → describe the change → you get **your own private copy** with the changed span highlighted amber. The original is never touched.
